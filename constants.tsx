...
// Mapping for beginner-friendly labels
...
// High-quality, realistic Staunton-style chess pieces (Cburnett set from Wikimedia Commons)
// These are hosted on a public CDN (Wikimedia) and render consistently across all browsers.
